...
//                    mBluetoothStuff.mTalker.write();
    ...
    @Override public void startLooking(IBluetoothClientListener listener) {
        if (mBluetoothStuff == null) {
    ...
    @Override public void connectToServer(BluetoothDevice device) {
        Log.i(TAG, "Totes going to do something with this now... " + device.getAddress());
        mBluetoothStuff.tryToConnectToServer(this, device);
    }
