 ...
 * From the example pages!
 * <p>
 * https://github.com/learnopengles/Learn-OpenGLES-Tutorials/blob/master/android/AndroidOpenGLESLessons/app/src/main/java/com/learnopengles/android/common/ShaderHelper.java
...
public class Utils {
    ...
    public static FloatBuffer createVertexBuffer(float[] vectors) {
